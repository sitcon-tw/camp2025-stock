...
from bot.pvp_manager import init_pvp_manager
...
async def error_handler(update: Optional[object], context: CallbackContext) -> None:
    ...
    if crashed_message:
        ...
        chat_name = escape_markdown(
            getattr(getattr(crashed_message, "chat", "chat 為空"), "title", "群組無名稱") or
...
async def initialize():
    ...
    bot.add_handler(CallbackQueryHandler(buttons.handle_pvp_click, pattern=r"^pvp:"))
