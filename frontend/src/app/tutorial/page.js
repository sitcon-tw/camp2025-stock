...
export default function TutorialPage() {
    return (<div className="bg-[#0f203e] min-h-screen pb-32">
        <div className="container mx-auto px-8 py-8 max-w-4xl">
            <h1 className="text-3xl font-bold text-center mb-8 text-[#82bee2]">📈 SITC 股市交易指南</h1>

            <div className="bg-[#1a2e4a] p-4 rounded-lg mb-8">
                <p className="text-md text-white">歡迎來到 SITCON Camp 的 SITC 模擬股市！你可以使用「營隊點數」來體驗<s>賭博</s>投資的樂趣，就算你從沒碰過股票也沒關係！</p>
            </div>
