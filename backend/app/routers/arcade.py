...
from app.schemas.arcade import ArcadeActionRequest, ArcadeActionResponse, ArcadeHealthResponse
...
@router.post("/arcade/deduct", response_model=ArcadeActionResponse)
...
@router.post("/arcade/add", response_model=ArcadeActionResponse)
